 ...
 * @param {Object} result {ErrCode, ErrMsg, Mote}
 */
...
exports.Reg = function(data, cb){
    ...
    if ( dcenter != '' ){
        ...
        ins.CallXrpc( dcenter, 'reg', dcData, null, null, function(reply){
            ...
            if ( reply.ErrCode == MC_OKCODE ){
                var einfo = NewEdgeInfo(reply.result.SToken, dcData.AppKey, dcData.EiToken, dcData.EiUMMA, dcData.EiUPort, reply.result.DDN, reply.result.WIP, reply.result.LIP);
...
var NewEdgeInfo = function(stoken, appkey, eitoken, eiumma, eiuport, ddn, wanip, lanip){
    var info = {"SToken":stoken,"AppKey":appkey,"EiToken":eitoken,"EiUMMA":eiumma,"EiUPort":eiuport,
    "DDN":ddn,"EiOwner":"","EiName":"","EiType":"","EiTag":"","WIP":wanip,"LIP":lanip,"TimeStamp":new Date()};
    return info;
}

var UpdateEdgeInfo = function(info){
    try {
        console.log('UpdateEdgeInfo info=%s', JSON.stringify(info));
