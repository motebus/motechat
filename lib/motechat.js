...
exports.Send = function(xmsg, cb){
    ...
    try {
        ...
        target = xmsg.Target;
        data = xmsg.Data;
        if ( typeof xmsg.SendTimeout != 'undefined') timeout = xmsg.SendTimeout;
        if ( typeof xmsg.WaitReply != 'undefined') waitreply = xmsg.WaitReply;
        ...
        if ( info != null ){
            ...
            if ( target != '' && data != null ){
                ...
                var xdata = {"stoken":stoken,"target":target,"in":{"fm":{"DDN":ddn,"Name":dname},"msgtype":"","t1":timeout,"t2":waitreply},"data":data};
                        ...
                        if ( typeof result.body != 'undefined' ){
                            ...
                            if ( typeof body.Reply != 'undefined'){
                                ...
                                if ( typeof reply.ErrCode != 'undefined' ){
                                    ...
                                    if ( edata.result != '' && edata.result != mcerr.MC_OKMSG ) retfail = true;
                                }
                            }
                            if ( edata.result == '' ){
...
exports.Call = function(xrpc, cb){
    ...
    try {
        ...
        func = xrpc.Func;
        data = xrpc.Data;
        if ( typeof xrpc.SendTimeout != 'undefined') timeout = xrpc.SendTimeout;
        if ( typeof xrpc.WaitReply != 'undefined') waitreply = xrpc.WaitReply;
                ...
                if ( target == 'UC' || target == 'uc' ){
                    if ( ucState == 'start' ){
                        try {
                            ...
                            if ( typeof cb == 'function' ) cb({"ErrCode":err.MC_ERRCODE,"ErrMsg":"mc: " + e.message});
                        }
                    }
                    else cb({"ErrCode":err.MC_ERRCODE,"ErrMsg":"mc: uc modules not open"});
                }
                else {
                    var dcData = {"stoken":stoken,"target":target,"func":func,"in":{"fm":{"DDN":ddn,"Name":dname},"t1":timeout,"t2":waitreply},"data":data};
                    ins.CallXrpc( dcenter, 'call', dcData, timeout, waitreply, function(result){
                        ...
                        if ( retfail == true ){
                            MoteErrHandler('call', edata.result, dcData.stoken);
                        }
                    });
                }
            } 
