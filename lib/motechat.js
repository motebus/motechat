...
//         check input parameter in open function
//         regCneter add unreg function   

var exports = module.exports = {};
var ver = '1.7.3';
var update = '2019/11/04'
var appname = '';
var iocmma = '';
var webtype = '';
var dcenter = '';
                        ...
                        setInfo( sdata, function(ret){
                            if ( ret.ErrCode == mcerr.MC_OKCODE ){
                                if ( typeof opencb == 'function' ) {
                                    let ei = reginfo.EdgeInfo;
                                    let {EiName,EiType,EiTag,EiLoc} = ei;
                                    regdata.EiName = EiName;
                                    regdata.EiType = EiType;
                                    regdata.EiTag = EiTag;
                                    regdata.EiLoc = EiLoc;
                                    let regret = {"ErrCode":mcerr.MC_OKCODE,"ErrMsg":mcerr.MC_OKMSG,"result":regdata};
                                    opencb(regret);
                                }
                            }
                            else {
