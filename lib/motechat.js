                    ...
                    mchatOpen(conf, function(result){
                        ...
                        if ( result.ErrCode == mcerr.MC_OKCODE ){
                            ...
                            if ( result.Mote ){
                                ...
                                if ( chkMMA(EiMMA) ) {
                                    if ( reginfo ) console.log('motechat:open reginfo=%s', JSON.stringify(reginfo));
                                ...
                                for ( var i = 0; i < cdata.length; i++ ) {
                                    ...
                                    if ( msg.IN ){
                                        ...
                                        if ( From && To && State ){
                                            ...
                                            let msg = xdata.data ? xdata.data : '';
                                            let edata = {"From":From,"To":To,"msg":msg,"result":ret};
                            ...
                            if ( iocmma ){
                                for ( var i = 0; i < cdata.length; i++ ) {
                                    ...
                                    if ( msg.IN ){
                                        ...
                                        if ( From && To && State ){
                                            if ( State.ErrMsg ) ret = State.ErrMsg;
                                            let msg = dcData.data ? dcData.data : '';
                                            let edata = {"From":From,"To":To,"msg":msg,"result":ret};
                                            if ( dbg >= 2 ) console.log('motechat:Send edata=%s', JSON.stringify(edata));
                                            if ( ret == mcerr.MC_OKMSG )
