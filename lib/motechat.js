...
// Date: 2019/08/27
// Version: 1.6.3
// Update: solve dup reg problem

var exports = module.exports = {};
var ver = '1.6.3';
var update = '2019/08/27'
var appname = '';
var iocmma = '';
var webtype = '';
var dcenter = '';
...
var mchatOpen = function(conf, reginfo, cb){
    ...
    console.log('motechat:open Heartbeat=%s', isPollDC);
    ...
    CallDcenterReset(function(reply){
        ...
        if ( reply.ErrCode == mcerr.MC_OKCODE ){
            ...
            if ( reginfo ){
                ...
                data = {"SToken":reginfo.SToken,"EiToken":reginfo.EiToken,"WIP":mcwanip,"LIP":mclanip,"Web":webtype};
    ...
    var _reg = function(data, msg, cb){
        ...
        if ( dcenter != '' ){
            ...
            ins.CallXrpc( dcenter, 'reg', dcData, null, null, function(reply){
                ...
                if ( reply.ErrCode == mcerr.MC_OKCODE ){
                    var ei = reply.result;
                    var einfo = NewEdgeInfo(ei.SToken, dcData.AppKey, ei.EiToken, dcData.EiUMMA, dcData.EiUPort, web, ei);
    ...
    if ( data ){
        if ( data.cmd ){
            ...
            if ( cmd == 'reginfo' ){
                ...
                let reply = {"response":"reginfo","ErrCode":amerr.SS_OKCODE,"ErrMsg":amerr.SS_OKMSG,"data":reginfo};
                cb(reply);
            }
            else if ( cmd == 'reset' ) {
        ...
        ins.CallXrpc( dcenter, 'poll', 'poll', null, null, function(reply){
            ...
            if ( reply.ErrCode == mcerr.MC_OKCODE ){
                if ( reply.result.length == 0 ){
                    ...
                    if ( reply.result.length != edgetable.length ){
                        let ei = [];
                ...
                ins.iocEvent('', mbusmma, 'error', 'in', {"Device":mbusmma,"action":"Heartbeat","result": "dc: " + reply.ErrMsg, "info": comment});
            }
        });
    }
}
