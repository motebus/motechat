                ...
                if ( func == 'regdc'){
                  ...
                  try {
                    if ( typeof msg.body.target != 'undefined' && typeof msg.body.data != 'undefined' ){
                      ...
                      var xmsgctl = {"SToken":stoken,"From":ddn,"Target":target,"Data":data,"SendTimeout":null,"WaitReply":WS_WAITREPLY_TIMEOUT};
  ...
  if ( msgtype == '' ){
    //if ( ch == 'xrpc'){
      ...
      if ( ix >= 0 ){
        ...
        if ( typeof cb == 'function' ) cb({"ErrCode":wserr.WS_NoMatchDDN,"ErrMsg":wserr.WS_NoMatchDDN_Msg});
      }
    //}
  }
  else {
